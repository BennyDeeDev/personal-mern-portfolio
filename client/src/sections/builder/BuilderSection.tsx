...
export default function BuilderSection({ title, onAdd, section, data, onDelete, render }) {
		...
		<div className="mt-4">
			<div className="bg-gray-500 rounded-lg p-4">
				<div className="flex items-center relative pb-2">
					...
					<button className="bg-white rounded-full absolute right-0 p-1" disabled={data}>
						<img
